...
- (void)performActionForMoPubSpecificURL:(NSURL *)URL
{
    ...
    switch (command) {
        ...
        case MPMoPubHostCommandFinishLoad:
            NSLog(@"MPAdWebViewAgent, performActionForMoPubSpecificURL : MPMoPubHostCommandFinishLoad" );
            [self.delegate adDidFinishLoadingAd:self.view];
            break;
        case MPMoPubHostCommandFailLoad:
            NSLog(@"MPAdWebViewAgent, performActionForMoPubSpecificURL : MPMoPubHostCommandFailLoad" );
            [self.delegate adDidFailToLoadAd:self.view];
            break;
        default:
            NSLog(@"MPAdWebViewAgent, performActionForMoPubSpecificURL: default - unsupported MoPub URL: %@", [URL absoluteString]);
