...
- (void)loadURL:(NSURL *)URL
{
    ...
    NSLog(@"MPAdServerComm, loadURL - URL: %@", URL.absoluteString);
    ...
    if (!MoPub.sharedInstance.isSdkInitialized) {
        ...
        NSLog(@"MPAdServerComm, failLoadForSDKInit");
    ...
    self.task = [MPHTTPNetworkSession startTaskWithHttpRequest:request responseHandler:^(NSData * data, NSHTTPURLResponse * response) {
        ...
        NSLog(@"MPAdServerComm, MPHTTPNetworkSession startTaskWithHttpRequest");
        ...
        NSLog(@"MPAdServerComm, strongSelf didFailWithError");
    }];
...
- (void)didFinishLoadingWithData:(NSData *)data {
    ...
    NSLog(@"MPAdServerComm, didFinishLoadingWithData - json override");
    ...
    if (responses == nil) {
        NSLog(@"MPAdServerComm, responses - nil");
     ...
     NSLog(@"MPAdServerComm, responses not nil");
    ...
    for (NSDictionary * responseJson in responses) {
        ...
        if (metadata == nil || (metadata != nil && metadata.count == 0)) {
            ...
            NSLog(@"MPAdServerComm - The metadata field is either non-existent or empty");
        ...
        if (configuration != nil) {
            ...
            NSLog(@"MPAdServerComm - Failed to generate configuration");

        }
    }

     NSLog(@"MPAdServerComm, configurations");
...
- (NSDictionary *)handleAdResponseOverrides:(NSDictionary *)serverResponseJson {
    ...
    MPLogInfo(@"handleAdResponseOverrides called");
