...
- (void)requestAdWithSize:(CGSize)size customEventInfo:(NSDictionary *)info
{
    ...
    NSLog(@"MPMRAIDBannerCustomEvent, loadAdWithConfiguration");
...
- (void)adDidLoad:(UIView *)adView
{
    ...
    NSLog(@"MPMRAIDBannerCustomEvent.m, adLoadSuccessForAdapter - mraidAdView");
...
- (void)adDidFailToLoad:(UIView *)adView
{
    ...
    NSLog(@"MPMRAIDBannerCustomEvent.m - adDidFailToLoad");
...
- (void)trackImpressionsIncludedInMarkup
{
    ...
    NSLog(@"MPMRAIDBannerCustomEvent, trackImpressionsIncludedInMarkup");
